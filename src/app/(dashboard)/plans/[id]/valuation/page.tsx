                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-200">
                        <th className="text-left py-2 px-2 font-medium text-gray-500 text-xs w-24">
                          Piano Rif.
                        </th>
                      ...
                      {unit.surfaces.map((surface) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Surface type label */}
                            <td className="py-1.5 px-2 text-gray-800 font-medium text-xs">
                              {isCustom ? (
                                <input
                                  type="text"
                                  className={cn(
                            ...
                            <td className="py-1.5 px-2">
                              <input
                                ...
                                step={0.01}
                                className={cn(
                                  'w-full rounded border border-gray-200 bg-white px-2 py-1 text-xs text-right',
                                  'focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500/20'
                                )}
                            ...
                            <td className="py-1.5 px-2">
                              <div className="relative">
                                <input
                                  ...
                                  step={1}
                                  className={cn(
                                    'w-full rounded border border-gray-200 bg-white px-2 py-1 pr-6 text-xs text-right',
                                    'focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500/20'
                                  )}
                                  value={
                            ...
                            <td className="py-1.5 px-2">
                              <div className="bg-gray-50 rounded px-2 py-1 text-xs text-right text-gray-700 font-medium">
                            ...
                            {/* Value (read-only) */}
                            <td className="py-1.5 px-2">
                              <div className="bg-gray-50 rounded px-2 py-1 text-xs text-right text-gray-700 font-semibold">
              ...
              <table className="w-full text-sm">
                ...
                <tfoot>
                  <tr className="border-t-2 border-gray-300">
                    <td className="py-3 px-3 font-bold text-gray-900">TOTALE</td>
