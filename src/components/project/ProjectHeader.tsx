...
export function ProjectHeader({ projectId }: ProjectHeaderProps) {
  ...
  return (
    <>
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-3 border-b border-[#1A1A24]/[0.06] bg-white/40 backdrop-blur-md">
        <button
          onClick={toggle}
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/60 backdrop-blur-xl border-t border-[#1A1A24]/[0.06] shadow-[0_-2px_8px_rgba(0,0,0,0.04)] safe-bottom">
